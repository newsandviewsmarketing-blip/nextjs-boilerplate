...
export default async function AdminCreatePage({ searchParams }: { searchParams: Promise<Params> }) {
  ...
  return <main><SiteHeader />
    ...
    <section className="section compact-section"><div className="shell admin-control-layout"><AdminNav roles={identity.roles}/><div className="admin-control-content">
      ...
      {kind === "person" && <form className="profile-form" action={createManagedPersonAction}>
        ...
        <div><label>Years experience</label><input name="years_experience" type="number" min="0" defaultValue="0" /></div><div><label>Image URL</label><input name="image_url" type="url" /></div>
      ...
      {kind === "company" && <form className="profile-form" action={createCompanyAction}>
        ...
        <div><label>Website</label><input name="website" /></div><div><label>Logo URL</label><input name="logo_url" type="url" /></div>
        <PakistanLocationFields />
        <div className="form-span-2"><label>Address</label><input name="address" /></div><div className="form-span-2"><label>Google Maps URL</label><input name="google_maps_url" type="url" /></div>
      ...
      {kind === "clinic" && <form className="profile-form" action={createClinicAction}>
      ...
      {kind === "laboratory" && <form className="profile-form" action={createLaboratoryAction}>
      ...
      {kind === "product" && <form className="profile-form" action={createAdminProductAction}>
      ...
      {kind === "job" && <form className="profile-form" action={createAdminJobAction}>
