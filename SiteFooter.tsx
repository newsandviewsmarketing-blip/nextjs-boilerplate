    ...
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div>
          ...
          <a href="https://vetnewsandviews.com" target="_blank" rel="noreferrer">Veterinary News & Views</a>
        </div>
        <div>
          <h3>Connect</h3>
          ...
          <p className="footer-note">Front-end preview. Live booking, payments, OTP, product orders and account data require backend services.</p>
        </div>
      </div>
      <div className="shell footer-bottom">
        <span>© 2026 VetConnect Pakistan</span>
        <span>Veterinary • Livestock • Poultry • Pets • Dairy • Fisheries • Animal Health</span>
      </div>
    </footer>
  );
}
